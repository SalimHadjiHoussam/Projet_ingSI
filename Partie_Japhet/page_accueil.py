...
IMAGE_MAISON = os.path.join(BASE_DIR, "Images", "IMG_9291.jpg")
...
class PageAccueil:
    def __init__(self, root):
        ...
        self.police_titre    = tkfont.Font(family="Arial", size=42, weight="bold")
        self.police_sous     = tkfont.Font(family="Arial", size=18, weight="bold")
        self.police_entete   = tkfont.Font(family="Arial", size=11)
        self.police_btn_ici  = tkfont.Font(family="Georgia", size=22, weight="bold",
                                           slant="italic")
        self.police_btn_thm  = tkfont.Font(family="Arial", size=11)
    ...
    def _construire_interface(self):
        ...
        self.btn_ici = tk.Button(
            ...
            width=12, pady=12,
            cursor="hand2",
            command=self._aller_creation_maison
        )
        self.btn_ici.pack()
    ...
    def _appliquer_theme(self):
        ...
        self.btn_theme.configure(bg=c["btn_fond"], fg=c["btn_texte"])
        ...
        self.btn_ici.configure(bg=c["btn_fond"], fg=c["btn_texte"])
    ...
    def _aller_creation_maison(self):
        ...
        from creation_maisons import PageCreationMaison
        PageCreationMaison(root2)
        root2.mainloop()

if __name__ == "__main__":
    root = tk.Tk()
    app = PageAccueil(root)
    root.mainloop()
